...
class PDFGenerator:
    ...
    def generate_bulletin(student_id):
        ...
        # Conversion dict to list for template
        processed_domains = []
        ...
        title = f"BULLETIN DE LA {class_obj.level}ème ANNEE CYCLE TERMINAL DE L'EDUCATION DE BASE (CTEB)" if class_obj.level in ['7', '8'] else f"BULLETIN DE LA {class_obj.name}"
